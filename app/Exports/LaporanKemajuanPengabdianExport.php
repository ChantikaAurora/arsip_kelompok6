...
class LaporanKemajuanPengabdianExport implements FromCollection, WithHeadings
{
    protected $search;
    ...
    {
        return LaporanKemajuanPengabdian::with(['skemaRelasi', 'jurusanRelasi', 'prodiRelasi'])
