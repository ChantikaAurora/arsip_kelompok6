...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 pb-2 border-bottom">
        <div class="d-flex align-items-center">
            ...
            <div>
                <h3 class="mb-0 fw-semibold">Metadata Proposal DIPA Penelitian</h3>
                <p class="text-muted mb-0">Rekapitulasi data dari proposal DIPA Penelitian yang tercatat.</p>
            </div>
        </div>
    </div>
    ...
    <div class="d-flex justify-content-between mb-3">
        <div class="d-flex gap-2">
            {{-- Tombol Kembali --}}
            <a href="{{ route('proposal_dipa_penelitian.index') }}" class="btn btn-secondary shadow-sm d-inline-flex align-items-center">
                <i class="icon-action-undo align-middle mr-1"></i>Kembali
            </a>

            {{-- Tombol Unduh --}}
            <a href="{{ route('proposal_dipa_penelitian.metadata.download', ['search' => request('search')]) }}" class="btn btn-success shadow-sm d-inline-flex align-items-center" style="margin-left: 0.5rem;">
    ...
    <div class="d-flex justify-content-end mb-3">
        <form method="GET" action="{{ route('proposal_dipa_penelitian.metadata') }}" class="d-flex">
