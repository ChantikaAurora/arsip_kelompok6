...
@section('title', 'Edit Proposal DIPA Penelitian')
...
<div class="container mt-4">
    <div class="border-bottom mb-4 pb-2">
        <h3 class="mb-3">Formulir Edit Proposal DIPA Penelitian</h3>
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <form action="{{ route('proposal_dipa_penelitian.update', $proposal->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
