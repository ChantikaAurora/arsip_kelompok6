            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  ...
                  <h6 class="font-weight-normal mb-0">Senang melihat anda kembali! <br>Sistem E-Arsip P3M siap membantu Anda mengelola dan mencari
                    dokumen dengan efisien dan aman</h6>
                </div>
                  ...
                  <div class="card card-tale">
                    <div class="card-body">
                      <!-- <p class="mb-4">Pengguna</p> -->
                         <h4 class="mb-4"><i class="mdi mdi-account mr-2"></i>Pengguna</h4>
                ...
                <div class="col-md-6 mb-4 stretch-card transparent">
                  <div class="card card-dark-blue">
                    <div class="card-body">
                      ...
                      <h4 class="mb-4"><i class="mdi mdi-email-receive mr-2"></i>Surat Masuk</h4>
