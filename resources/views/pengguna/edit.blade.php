...
<div class="container mt-4">
    ...
    <div class="border-bottom mb-4 pb-2">
        <h3 class="mb-2">Formulir Edit Pengguna</h3>
        <p class="text-muted mb-0">Silakan lengkapi data pengguna dengan benar untuk diperbaharui ke sistem arsip.</p>
    </div>
            ...
            <form method="POST" action="{{ route('pengguna.update', $pengguna->id) }}">
                ...
                <div class="form-group row">
                    <div class="col-sm-10 offset-sm-2 d-flex">
                        ...
                        <button type="submit" class="btn btn-primary" style="margin-left: 0.5rem;"><i class="bi bi-save"></i>
                           Update
                        </button>
                    </div>
                </div>
