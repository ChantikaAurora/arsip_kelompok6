...
<div class="container mt-4">
    <div class="border-bottom mb-4 pb-2">
        <h3 class="mb-2">Formulir Edit Surat Keluar</h3>
        <p class="text-muted mb-0">Silakan perbarui data surat keluar sesuai kebutuhan.</p>
    </div>
    ...
    <div class="card shadow-sm">
        <div class="card-body px-4 py-4">
            <form method="POST" action="{{ route('suratkeluar.update', $suratkeluar->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="nomor_agenda" class="form-control @error('nomor_agenda') is-invalid @enderror" value="{{ old('nomor_agenda', $suratkeluar->nomor_agenda) }}">
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="kode_klasifikasi" class="form-control @error('kode_klasifikasi') is-invalid @enderror" value="{{ old('kode_klasifikasi', $suratkeluar->kode_klasifikasi) }}">
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="tujuan_surat" class="form-control @error('tujuan_surat') is-invalid @enderror" value="{{ old('tujuan_surat', $suratkeluar->tujuan_surat) }}">
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="penerima" class="form-control @error('penerima') is-invalid @enderror" value="{{ old('penerima', $suratkeluar->penerima) }}">
                                </div>
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="jenis" class="form-control @error('jenis') is-invalid @enderror">
                                        ...
                                        @foreach ($jenisarsips as $jenis)
                                            <option value="{{ $jenis->id }}" {{ old('jenis', $suratkeluar->jenis) == $jenis->id ? 'selected' : '' }}>{{ $jenis->jenis }}</option>
                                        @endforeach
                                    </select>
                                </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                {{-- Cek dan tampilkan file jika ada --}}
                                @if ($suratkeluar->file && file_exists(public_path('storage/' . $suratkeluar->file)))
                                    <div class="mt-2">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    ...
                                    <textarea name="keterangan" class="form-control @error('keterangan') is-invalid @enderror" rows="3">{{ old('keterangan', $suratkeluar->keterangan) }}</textarea>
                                </div>
