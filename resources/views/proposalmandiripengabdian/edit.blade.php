...
@section('title', 'Edit Proposal Mandiri Pengabdian')
...
<div class="container mt-4">
    <div class="border-bottom mb-4 pb-2">
        ...
        <h3 class="mb-3">Formulir Edit Proposal Mandiri Pengabdian</h3>
        <p class="text-muted">Silakan perbarui data proposal sesuai kebutuhan.</p>

        <h3 class="mb-2">Formulir Edit Proposal Mandiri Pengabdian</h3>
    ...
    <div class="card shadow-sm">
        <div class="card-body px-4 py-4">
            <form action="{{ route('proposal_mandiri_pengabdian.update', $proposal->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
