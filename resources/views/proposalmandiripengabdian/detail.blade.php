...
<div class="container">
    ...
    {{-- Tombol Kembali --}}
    <a href="{{ route('proposal_mandiri_pengabdian.index') }}" class="btn btn-secondary shadow-sm mb-3">
    ...
    <div class="card shadow-lg border-0 rounded-4">
        <div class="card-header text-white rounded-top-4"
            ...
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h5 class="mb-0 fw-semibold">Detail Proposal Mandiri Pengabdian</h5>
                    <small class="text-light fst-italic">Informasi lengkap proposal pengabdian mandiri yang tercatat dalam sistem.</small>
                </div>
            </div>
        </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="white-space: normal; word-break: break-word; max-width: 300px;">
                                    @if ($proposal->file)
                                        <a href="{{ route('proposal_mandiri_pengabdian.download', ['id' => $proposal->id, 'preview' => 1]) }}"
                ...
                <div class="col-md-5">
                    @if ($proposal->file)
                        <div class="mb-3 text-end">
                            <a href="{{ route('proposal_mandiri_pengabdian.download', $proposal->id) }}"
                        ...
                        <div class="border rounded-4 shadow overflow-hidden" style="height: 547px;">
                            <iframe
                                src="{{ route('proposal_mandiri_pengabdian.download', ['id' => $proposal->id, 'preview' => 1]) }}"
                                width="100%"
                                height="100%"
                                style="border: none;"
                                loading="lazy">
                    ...
                    @else
                        <div class="alert alert-warning text-center shadow-sm rounded-3">
                            <i class="bi bi-exclamation-circle-fill"></i> Tidak ada file yang diunggah.
                        </div>
                    @endif
                </div>
