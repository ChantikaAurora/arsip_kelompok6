...
<div class="container mt-4">
    <h4>Daftar Metadata Laporan Kemajuan Penelitian</h4>

    <a href="{{ route('laporan_kemajuan_penelitian.index') }}" class="btn btn-outline-secondary mb-3">
        <i class="bi bi-arrow-left-circle"></i> Kembali
    </a>
    <a href="{{ route('laporan_kemajuan_penelitian.metadata.export', ['search' => request('search')]) }}" class="btn btn-outline-success mb-3">
        ⬇ Export ke Excel
    </a>
    ...
    <div class="d-flex justify-content-end mb-3">
        <form class="d-flex" method="GET" action="{{ route('laporan_kemajuan_penelitian.metadata') }}">
            <input
                type="text"
                name="search"
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="white-space: normal; word-wrap: break-word;">{{ $item->skemaRelasi->skema_penelitian ?? '-' }}</td>
            ...
            @empty
            <tr>
                <td colspan="7" class="text-center">Belum ada data metadata laporan kemajuan penelitian.</td>
            </tr>
            @endforelse
        </tbody>
    </table>
