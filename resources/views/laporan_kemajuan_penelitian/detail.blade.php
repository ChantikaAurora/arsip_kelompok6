...
<div class="container mt-4">
    <a href="{{ route('laporan_kemajuan_penelitian.index') }}" class="btn btn-secondary rounded-pill shadow-sm mb-3">Kembali</a>
        ...
        <div class="card-header text-white rounded-top-4"
            ...
            <div class="d-flex align-items-center">
                ...
                <div>
                    ...
                    <small class="text-light fst-italic">Informasi lengkap Laporan Kemajuan Penelitian</small>
                </div>
            </div>
        </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="white-space: normal; word-break: break-word; max-width: 300px;">
                                    @if($laporan->file)
                                        <a href="{{ route('laporan_kemajuan_penelitian.preview', [$laporan->id_laporan, 'preview' => 1]) }}"
