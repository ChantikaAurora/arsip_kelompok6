...
<div class="container mt-4">
    <div class="border-bottom mb-4 pb-2">
        <h3 class="mb-3">Formulir Tambah Laporan Kemajuan Penelitian</h3>
        <p class="text-muted">Isi data laporan kemajuan penelitian dengan lengkap dan benar.</p>
    </div>
    ...
    <div class="card-body">
        <form action="{{ route('laporan_kemajuan_penelitian.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
             ...
             {{-- Kode --}}
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="id_laporan" class="form-control @error('id_laporan') is-invalid @enderror" value="{{ old('id_laporan') }}" placeholder="Contoh: 345123">
                        @error('id_laporan')
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="judul_kegiatan" class="form-control @error('judul_kegiatan') is-invalid @enderror" value="{{ old('judul_kegiatan') }}" placeholder="Contoh: Penelitian XYZ">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="nama_ketua" class="form-control @error('nama_ketua') is-invalid @enderror" value="{{ old('nama_ketua') }}" placeholder="Contoh: Dr. Andi">
                    @error('nama_ketua')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="nama_anggota" class="form-control @error('nama_anggota') is-invalid @enderror" value="{{ old('nama_anggota') }}" placeholder="Contoh: Budi, Siti">
                    @error('nama_anggota')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
