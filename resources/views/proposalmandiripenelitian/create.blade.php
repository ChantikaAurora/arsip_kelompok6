...
<div class="container mt-4">
    <div class="border-bottom mb-4 pb-2">
        <h3 class="mb-2">Formulir Tambah Proposal Mandiri Penelitian</h3>
    ...
    <div class="card shadow-sm">
        <div class="card-body px-4 py-4">
            <form action="{{ route('proposal_mandiri_penelitian.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="skema_penelitian_id" class="form-control @error('skema_penelitian_id') is-invalid @enderror">
                                        ...
                                        @foreach($skemaPenelitians as $skema)
                                            <option value="{{ $skema->id }}" {{ old('skema_penelitian_id') == $skema->id ? 'selected' : '' }}>{{ $skema->skema_penelitian }}</option>
                                        @endforeach
                                    </select>
                                </div>
