...
<div class="container mt-4">
    <h4 class="mb-3">Metadata Proposal mandiri Penelitian</h4>

    <div class="d-flex justify-content-between mb-3">
        <a href="{{ route('proposal_mandiri_penelitian.index') }}" class="btn btn-secondary">← Kembali</a>
        <a href="{{ route('proposal_mandiri_penelitian.export', ['search' => request('search')]) }}" class="btn btn-success">
            📁 Download Excel
        </a>
    </div>
    ...
    <tr>
        ...
        <td>
            @if($item->file)
                <a href="{{ route('proposal_mandiri_penelitian.download', $item->id) }}" target="_blank">📄 Lihat</a>
            @else
                -
            @endif
        </td>
