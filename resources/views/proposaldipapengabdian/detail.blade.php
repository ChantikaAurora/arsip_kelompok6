...
<div class="container mt-4">
    <a href="{{ route('proposal_dipa_pengabdian.index') }}" class="btn btn-secondary mb-3">
        <i class="bi bi-arrow-left-circle"></i> Kembali
    </a>

    <div class="card shadow">
        <div class="card-header bg-primary text-white">
            <h5>Detail Proposal DIPA pengabdian</h5>
        </div>
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-5">
                    @if ($proposal->file)
                        <div class="mb-3 text-end">
                            <a href="{{ route('proposal_dipa_pengabdian.download', $proposal->id) }}" class="btn btn-success btn-sm" target="_blank">
                                <i class="bi bi-download"></i> Download
                            </a>
                            <a href="{{ route('proposal_dipa_pengabdian.download', ['id' => $proposal->id, 'preview' => 1]) }}" class="btn btn-primary btn-sm" target="_blank">
