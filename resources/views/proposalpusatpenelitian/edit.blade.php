...
<div class="container mt-4">
    <div class="border-bottom mb-4 pb-2">
        <h3 class="mb-2">Formulir Edit Proposal Pusat Penelitian</h3>
    ...
    <div class="card shadow-sm">
        <div class="card-body px-4 py-4">
            <form method="POST" action="{{ route('proposal_pusat_penelitian.update', $proposal->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
