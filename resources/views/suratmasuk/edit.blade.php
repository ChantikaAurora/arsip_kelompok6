            ...
            <form action="{{ route('suratmasuk.update', $suratmasuk->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        ...
                        value="{{ old('kode_klasifikasi', $suratmasuk->kode_klasifikasi) }}" required>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <textarea name="keterangan" rows="3" class="form-control @error('keterangan') is-invalid @enderror">{{ old('keterangan', $suratmasuk->keterangan) }}</textarea>
