...
<div class="container">
    ...
    {{-- Tombol Kembali --}}
    <a href="{{ route('laporan_kemajuan_pengabdian.index') }}" class="btn btn-secondary shadow-sm mb-3">
        ...
        <div class="card-header text-white rounded-top-4"
            ...
            <div class="d-flex align-items-center">
                ...
                <div>
                    ...
                    <small class="text-light fst-italic">Informasi lengkap laporan kemajuan pengabdian yang tercatat dalam sistem.</small>
                </div>
            </div>
        </div>
