...
<div class="container mt-4">
    <a href="{{ route('laporan_kemajuan_pengabdian.index') }}" class="btn btn-secondary rounded-pill shadow-sm mb-3">Kembali</a>
    ...
    <div class="card shadow-lg border-0 rounded-4">
        <div class="card-header text-white rounded-top-4"
            ...
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h5 class="mb-0 fw-semibold">Detail Laporan Kemajuan Pengabdian</h5>
                    <small class="text-light fst-italic">Informasi lengkap Laporan Kemajuan Pengabdian</small>
                </div>
            </div>
        </div>
                    ...
                    <table class="table table-striped table-hover table-bordered mb-0" style="table-layout: fixed; width: 100%;">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="white-space: normal; word-break: break-word;">{{ $laporan->nama_anggota }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td style="white-space: normal; word-break: break-word;">{{ $laporan->ringkasan }}</td>
                            </tr>
                            <tr>
                                <th class="bg-light">File Laporan</th>
                                <td style="white-space: normal; word-break: break-word; max-width: 300px;">
                                    @if($laporan->file)
                                        <a href="{{ route('laporan_kemajuan_pengabdian.preview', [$laporan->id_laporan, 'preview' => 1]) }}"
                ...
                <div class="col-md-5">
                    @if($laporan->file)
                        <div class="mb-3 text-end">
                            <a href="{{ route('laporan_kemajuan_pengabdian.download', $laporan->id_laporan) }}"
                               class="btn btn-outline-success btn-sm shadow-sm rounded-pill me-1"
                               target="_blank">
                                <i class="bi bi-download"></i> Download
                            </a>
                            <a href="{{ route('laporan_kemajuan_pengabdian.preview', ['id' => $laporan->id_laporan, 'preview' => 1]) }}"
                        ...
                        <div class="border rounded-4 shadow overflow-hidden" style="height: 550px;">
                            <iframe
                                src="{{ route('laporan_kemajuan_pengabdian.preview', ['id' => $laporan->id_laporan, 'preview' => 1]) }}"
                                width="100%"
                                height="100%"
                                style="border: none;"
                                loading="lazy">
