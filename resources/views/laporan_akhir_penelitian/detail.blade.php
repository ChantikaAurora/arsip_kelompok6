...
<div class="container mt-4">
    <a href="{{ route('laporan_akhir_penelitian.index') }}" class="btn btn-secondary rounded-pill shadow-sm mb-3">Kembali</a>
        ...
        <div class="card-header text-white rounded-top-4"
            ...
            <div class="d-flex align-items-center">
                ...
                <div>
                    ...
                    <small class="text-light fst-italic">Informasi lengkap Laporan Akhir Penelitian</small>
                </div>
            </div>
        </div>
