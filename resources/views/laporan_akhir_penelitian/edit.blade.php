...
<div class="container mt-4">
    ...
    <div class="card shadow-sm">
        <div class="card-body px-4 py-4">
            <form method="POST" action="{{ route('laporan_akhir_penelitian.update', $laporan_akhir_penelitian->id_laporan_akhir) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="skema" class="form-control @error('skema') is-invalid @enderror">
                                        ...
                                        @foreach ($skemas as $skema)
                                            <option value="{{ $skema->id }}" {{ old('skema', $laporan_akhir_penelitian->skema_id) == $skema->id ? 'selected' : '' }}>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="tahun_pelaksanaan" class="form-control @error('tahun_pelaksanaan') is-invalid @enderror" value="{{ old('tahun_pelaksanaan', $laporan_akhir_penelitian->tahun_pelaksanaan) }}" placeholder="Contoh: 2025">
                                </div>
