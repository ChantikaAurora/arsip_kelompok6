...
<div class="container mt-4">
    <div class="border-bottom mb-4 pb-2">
        <h3 class="mb-3">Formulir Tambah Laporan Akhir Penelitian</h3>
        <p class="text-muted">Isi data laporan akhir penelitian dengan lengkap dan benar.</p>
    </div>
    ...
    <div class="card-body">
        <form action="{{ route('laporan_akhir_penelitian.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
