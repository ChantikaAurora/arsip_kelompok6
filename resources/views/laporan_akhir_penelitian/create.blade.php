...
<div class="container mt-4">
    ...
    <div class="border-bottom mb-4 pb-2">
        <h3 class="mb-2">Formulir Tambah Laporan Akhir Penelitian</h3>
        <p class="text-muted mb-0">Silakan lengkapi informasi laporan akhir dengan benar.</p>
    </div>
    ...
    <div class="card shadow-sm">
        <div class="card-body px-4 py-4">
            <form method="POST" action="{{ route('laporan_akhir_penelitian.store') }}" enctype="multipart/form-data">
                @csrf
