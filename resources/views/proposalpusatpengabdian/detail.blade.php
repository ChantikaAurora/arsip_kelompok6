...
<div class="container">
    ...
    {{-- Tombol Kembali --}}
    <a href="{{ route('proposal_pusat_pengabdian.index') }}" class="btn btn-secondary shadow-sm mb-3">
    ...
    <div class="card shadow-lg border-0 rounded-4">
        <div class="card-header text-white rounded-top-4"
            ...
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h5 class="mb-0 fw-semibold">Detail Proposal Pusat Pengabdian</h5>
                    <small class="text-light fst-italic">Informasi lengkap proposal yang diajukan ke Pusat Pengabdian.</small>
                </div>
            </div>
        </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="white-space: normal; word-break: break-word; max-width: 300px;">
                                    @if ($proposal->file)
                                        <a href="{{ route('proposal_pusat_pengabdian.download', ['id' => $proposal->id, 'preview' => 1]) }}"
                ...
                <div class="col-md-5">
                    @if ($proposal->file)
                        <div class="mb-3 text-end">
                            <a href="{{ route('proposal_pusat_pengabdian.download', $proposal->id) }}"
                        ...
                        <div class="border rounded-4 shadow overflow-hidden" style="height: 547px;">
                            <iframe
                                src="{{ route('proposal_pusat_pengabdian.download', ['id' => $proposal->id, 'preview' => 1]) }}"
                                width="100%"
                                height="100%"
                                style="border: none;"
                                loading="lazy">
