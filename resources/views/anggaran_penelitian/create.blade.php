...
<div class="container mt-4">
    <div class="border-bottom mb-4 pb-2">
        <h3 class="mb-2">Formulir Tambah Laporan Keuangan Penelitian</h3>
        <p class="text-muted mb-0">Isi data laporan keuangan penelitian anda dengan lengkap dan benar.</p>
    </div>
    ...
    <div class="card shadow-sm">
        <div class="card-body px-4 py-4">
            <form method="POST" action="{{ route('anggaran_penelitian.store') }}" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="kegiatan" class="form-control @error('kegiatan') is-invalid @enderror" value="{{ old('kegiatan') }}" placeholder="Contoh: Penelitian Teknologi Tepat Guna">
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input type="number" name="volume_usulan" class="form-control @error('volume_usulan') is-invalid @enderror" value="{{ old('volume_usulan') }}" placeholder="Contoh: 3">
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input type="number" step="0.01" name="total_anggaran" class="form-control @error('total_anggaran') is-invalid @enderror" value="{{ old('total_anggaran') }}" placeholder="Contoh: 15000000">
                                </div>
