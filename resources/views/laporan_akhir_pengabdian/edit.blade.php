...
@section('title', 'Edit Laporan Akhir Pengabdian')
...
<div class="container mt-4">
    <div class="border-bottom mb-4 pb-2">
        ...
        <p class="text-muted mb-0">Silakan perbarui data laporan akhir sesuai kebutuhan.</p>
    </div>
                            ...
                            <div class="col-sm-8">
                                <select name="skema" class="form-control @error('skema') is-invalid @enderror">
                                    ...
                                    @foreach ($skemas as $skema)
                                        <option value="{{ $skema->id }}" {{ old('skema', $laporan_akhir_pengabdian->skema_id) == $skema->id ? 'selected' : '' }}>{{ $skema->skema_penelitian }}</option>
                                    @endforeach
                                </select>
